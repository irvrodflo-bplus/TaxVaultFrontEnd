...
class CFDIWebserviceManagerRe {
    ...
    public function createTableIfNotExists() {
        $sql = "CREATE TABLE IF NOT EXISTS cfdi_recibidos (
        ...
        try {
            $this->db->exec($sql);
            // echo "✅ Tabla cfdi_recibidos creada o verificada\n";
        } catch (PDOException $e) {
    ...
    public function insertarRegistros($registros) {
        ...
        $sql = "INSERT INTO cfdi_recibidos (
...
function descargarCFDIsRecibidos($fechaInicial, $fechaFinal, $rfc, $tipoComprobante = null) {
    $manager = new CFDIWebserviceManagerRe();
...
if (__FILE__ == $_SERVER['SCRIPT_FILENAME']) {
    ...
    // Ejecutar descarga
    $resultado = descargarCFDIsRecibidos($fechaInicial, $fechaFinal, $rfc);
